...
if __name__ == "__main__":
    ckpt_path = sys.argv[1] if len(sys.argv) > 1 else "mario_q_target_cr.pth"
    ...
    video = cv2.VideoWriter('mario_cr.mp4', fourcc, 50.0, (256, 240))
    ...
    print("Gameplay video saved as 'mario_cr.mp4'")
