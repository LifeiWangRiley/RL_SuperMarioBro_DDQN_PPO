...
#     # Add a channel dimension if it's missing (for grayscale images)
#     if len(s.shape) == 2:
#         s = np.expand_dims(s, axis=-1)

#     # Now the shape should definitely be 3
#     assert len(s.shape) == 3

#     # Transpose the array to have the channel as the first dimension
...
class model(nn.Module):
    def __init__(self, n_frame, n_action, device):
        ...
        # self.layer1 = nn.Conv2d(1, 32, 8, 4)
...
if __name__ == "__main__":
    ...
    env = wrap_mario(env, width=256, height=240, saved_path=r"C:\Users\wlf04\Desktop\CSCN8020 Reinforcement Learning Programming\DDQN_py\custom_reward")
